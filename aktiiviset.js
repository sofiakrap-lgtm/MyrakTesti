  ...
  var REAL_POSTS = {
    ...
    turuntie68: [
      ...
      { date: '14.7.2026', image: 'kuvat/referenssit/mannerheimintie94.jpg',
        ...
        excerpt: { fi: 'Käynnissä: molempien julkisivujen maantasokerroksen pohjarappaustyöt, K-kaupan edustan seinän vesipeltien asennus, Nordenskiöldinkadun ikkunakaulureiden rappaus sekä maantasokerrosten ikkunoiden pellitys- ja kaulureiden rappaustyöt. Työt jatkuvat.', sv: 'Pågår: grundputs i bottenvåningen på båda fasaderna, montering av vattenplåtar på väggen framför K-butiken, putsning av fönsterkragarna på Nordenskiöldsgatan samt plåtarbeten och kragputs vid bottenvåningens fönster. Arbetena fortsätter.', en: 'Under way: base rendering at ground level on both facades, installation of flashings on the wall in front of the K-store, rendering of the Nordenskiöldinkatu window collars, and flashing and collar rendering at the ground-floor windows. The work continues.' } },
